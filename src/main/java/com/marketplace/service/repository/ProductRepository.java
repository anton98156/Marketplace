...
public class ProductRepository {
    ...
    public Product save(Product product) {
        ...
        jdbc.update(sql, product.getName(), product.getDescription(), product.getPrice(), product.isStock());
        return product;
    }
    ...
    public Product updateById(Product product, int id) {
        ...
        jdbc.update(sql, product.getName(), product.getDescription(), product.getPrice(), product.isStock(), id);
        return product;
    }
